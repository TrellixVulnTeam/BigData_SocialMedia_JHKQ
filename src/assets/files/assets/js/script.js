...
$('#styleSelector').append('' +
	...
	$('body').append('' +
        ...
        '<a href="https://themeforest.net/item/able-pro-responsive-bootstrap-4-admin-template/19300403?ref=phoenixcoded" target="_blank" class="btn btn-md btn-buy" onClick="gtag(\'event\', \'click\', {\'event_category\': \'buynow\',\'event_label\': \'buy-now\',\'value\': 1 });" >' +
