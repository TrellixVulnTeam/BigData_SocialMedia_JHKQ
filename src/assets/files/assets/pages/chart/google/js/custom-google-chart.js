...
$(document).ready(function() {
    ...
    function drawStacked() {
        var data = google.visualization.arrayToDataTable([
            ['City', 'Before World Cup', 'During World Cup'],
        ...
        var options = {
            title: 'Cities with Most Tweets at World Cup',
            chartArea: { width: '50%' },
            isStacked: true,
            hAxis: {
                title: 'Total Tweets',
    ...
    function drawSeriesChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['ID', 'Before World Cup', 'During World Cup', 'Region', 'Population'],
        ...
        var options = {
            title: 'Countries representaion',
            hAxis: { title: 'Before World Cup' },
            vAxis: { title: 'During World Cup' },
    ...
    function drawChartWaterfall() {
        ...
        var optionsWaterfall = {
            ...
            candlestick: {
                fallingColor: { strokeWidth: 0, fill: '#ff5252' }, // red
                risingColor: { strokeWidth: 0, fill: '#11c15b' } // green
            }
        };
